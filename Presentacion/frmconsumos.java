...
public static String idreserva;  //pa almacenar el idreserva q esta realizando el consumo
public static String cliente; 
    ...
    public frmconsumos() {
        initComponents(); 
        mostrar(idreserva);
        //pa q se muestre de manera autom el cliente y la reserva q reaiza dicho consumo
    ...
    void mostrar(String buscar) {
        try {
            ...
            lblconsumo.setText("Consumo Total $. " + func.totalconsumo); //mostrar el total de consumo q obtuve en mi clase fconsumo(mostrar)
        } catch (Exception e) {
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGap(0, 0, Short.MAX_VALUE)
                        .addComponent(lblconsumo, javax.swing.GroupLayout.PREFERRED_SIZE, 14, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(115, 115, 115)
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(lbltotalregistros, javax.swing.GroupLayout.DEFAULT_SIZE, 25, Short.MAX_VALUE)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addComponent(lblconsumo, javax.swing.GroupLayout.PREFERRED_SIZE, 2, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(0, 0, Short.MAX_VALUE))))
        );
    ...
    private void tablalistadoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablalistadoMouseClicked
        ...
        //filas q se encuentran en fconsumo
    ...
    private void btneliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btneliminarActionPerformed
        ...
        if (!txtidconsumo.getText().equals("")) {
            ...
            if (confirmacion==0) {  // si es instancio
                fconsumo func = new fconsumo ();
                vconsumo dts= new vconsumo();  // pa poder enviarle el valor
                //le envio a mi obj dts asu metodo setIdconsumo  lo q esta escrito en mi caja idconsumo pa poder elim ese cons en especifico
    ...
    private void btnguardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnguardarActionPerformed
        // validar q usu halla seleccionado un prod d la lista de prod q el cliente kiera comprar
        ...
        fconsumo func = new fconsumo();  //funciones
        //enviar uno a uno los vamores
        ...
        //enviar el item seleccionado d mi cbo hacia me metodo setEstado
        ...
        if (accion.equals("guardar")) {
            if (func.insertar(dts)) {
                ...
                mostrar(idreserva); //pa mostrar sol los consumos d dicha reserva y no de todos, osea en vez de "" pongo idreserva
                inhabilitar();
