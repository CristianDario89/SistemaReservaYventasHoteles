...
public class frmusuariologin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btningresar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Logica/guardar.png"))); // NOI18N
        ...
        btnsalir.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Logica/salir.gif"))); // NOI18N
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Logica/usuario.png"))); // NOI18N
    ...
    private void btningresarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btningresarActionPerformed
        ...
        try {
            ...
            //le envio valores a modelo
            modelo=func.login(dts.getLogin(),dts.getPassword());
            //todo este mdelo se lo envio(con setModel) a tablalistado pa obtener los datos d ese usuario
            tablalistado.setModel(modelo);
            
            if (func.totalregistros >0) {  //pa determinar si el usu existe, si esta registrado en trabajadores
                this.dispose();
                frminicio form = new frminicio();
                form.toFront();
                form.setVisible(true);
                //le envio a cada uno d los labels todos los datos del usu q estan almacenado en tablalistado
                //recordar q son las col q estan la ftrabajador, en la funcion login, q esta instanciando my obj en btnIngresar 
                ...
                if (!frminicio.lblacceso.getText().equals("Administrador")) {  //
                    ...
                    frminicio.mnuconf.setEnabled(false);
                }
