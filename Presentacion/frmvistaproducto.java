...
public class frmvistaproducto extends javax.swing.JFrame {
    ...
    private void tablalistadoMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablalistadoMousePressed
        ...
        if (evt.getClickCount()==2) {
            int fila= tablalistado.getSelectedRow(); //pa obtener el indice de la fila el cual el usu ha hecho click

            String cod,valor1,valor2;  //almacenamiento

            cod=tablalistado.getValueAt(fila,0).toString();  //getValueAt : pa obtener el valor
            valor1=tablalistado.getValueAt(fila,1).toString();
            valor2=tablalistado.getValueAt(fila,4).toString();
            //enviar los valores a mi tabla frmConsumo
            frmconsumos.txtidproducto.setText(cod);
            frmconsumos.txtproducto.setText(valor1);
            frmconsumos.txtprecio_venta.setText(valor2);
            //luego q ete form se oculte
